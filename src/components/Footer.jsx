        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <span className="text-primary-400 font-display text-2xl font-bold">Soft<span className="text-accent-500">Sell</span></span>
            </div>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">Supported Vendors</h3>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Autodesk</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">License Agreements</a></li>
            </ul>
          </div>
        </div>
